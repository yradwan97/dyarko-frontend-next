...
const SingleTent = ({ tent }) => {
    ...
    return (
        <ul className='space-y-2 list-disc sm:space-y-5'>
            ...
            <li className='ml-4'>
                {t("price")}: <span className='ml-1 lg:ml-3 text-main-600 font-bold'>{t("kwd")} {tent?.price}</span>
            </li>
            <li className='ml-4'>
                {t("insurance")}: <span className='ml-1 lg:ml-3 text-main-600 font-bold'>{t("kwd")} {tent?.insurance}</span>
            </li>
            <li className='ml-4'>
