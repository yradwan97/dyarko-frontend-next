    ...
    return (
        <div className={`${visible ? "flex space-y-2" : "hidden lg:flex"} lg:w-3/12`}>
            <ul>
                ...
                <li>
                    <Button
                        className={`${defaultLinkClass} flex ${locale === "ar" ? "flex-row-reverse gap-x-2" : "flex-row"} w-full items-center justify-between`}
